# Manual OpenTofu Import Reference

Use this workflow when you are working in OpenTofu, or whenever Terraform Search is unavailable or inappropriate.
...
echo "Run 'tofu plan' to review, then 'tofu apply' to import"
```
