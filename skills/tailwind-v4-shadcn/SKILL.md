...
8. Wrap ANY styles in `@layer base` without understanding CSS layer ordering (see error #8)
...
- **reference/architecture.md** - Deep dive into 4-step pattern
- **reference/dark-mode.md** - Complete dark mode implementation
- **reference/common-gotchas.md** - Troubleshooting guide
- **reference/migration-guide.md** - v3 → v4 migration
